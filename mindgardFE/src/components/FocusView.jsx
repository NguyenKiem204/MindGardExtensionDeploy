...
export default function FocusView() {
  ...
  async function startFocus() {
    setViewMode("focus");
    // Read the current focusMode setting and propagate
    try {
      const settings = await window.chrome.storage.local.get(['focusMode', 'currentFocusTopic']);
      const focusMode = settings.focusMode || 'manual';
      window.chrome.storage.local.set({
